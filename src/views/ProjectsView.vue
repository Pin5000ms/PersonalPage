...
import projectsBanner from '../assets/projects_banner.jpg'
...
<template>
  <div class="view-shell">
    <section class="page-intro">
      <div class="page-banner" aria-label="Projects banner">
        <div class="page-banner-frame">
          <img class="page-banner-image" :src="projectsBanner" alt="Projects page banner" />
