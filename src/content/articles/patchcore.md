...
以下是WideResNet50架構示意圖，會拿layer2和layer3的輸出來用(f2、f3)
...
以下是f2與f3串接示意圖，會先將f3 upscale，再與f2做串接
...
以下是layer1的bottleneck block的詳細展開圖
...
所以很多人第一次接觸 PatchCore 時會以為它是一個「訓練好的瑕疵分類器」，這其實不太對。
